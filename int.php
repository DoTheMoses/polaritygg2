...
<title>Polarity: Internal Page</title>
<meta charset="utf-8" />
...
<div class="container-fluid content-section">
  <div class="container">
    ...
    <div class="content-box">
      <p>Here's all our internal stuff.</p>

      <div class="container-fluid no-padding">
        <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 no-padding">
            <h2><a href="#Backet_Upload">Bracket Upload</a></h2>
        </div>        
        <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 no-padding">
...
<!-- begin Backet_Upload -->
<span class="anchor" id="Backet_Upload"></span>

<div class="container-fluid content-section">
  <div class="container">

    <div class="container-fluid content-box back-to-top">
      <h3>Backet Upload</h3>

      <p>First go to <a href="https://t.polarity.gg/admin/">https://t.polarity.gg/admin/</a>.
      In the field in the middle of the page, type the usual password, with the first two letters
      capitalized, and a ! at the end.
      </p>
  ...
  <div class="container">
    ...
    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-7 no-padding">
      <div class="content-box back-to-top">
        ...
        <p> Here are our announcements for today:</p>
    ...
    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-7 no-padding">
      <div class="content-box back-to-top">
        ...
        <ul>
          ...
          <li><a href="https://docs.google.com/spreadsheets/d/1s5AfB0umxPIrM0C8dLjQ5ZIGXqF04Pzh2guqNJ8CiKs/edit?usp=sharing/">Match Histories</a> &squf;</li>
          <li><a href="https://challonge.com/amlseason2finals/">Final Bracket</a> &squf;</li>

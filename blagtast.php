...
<div class="container" style="margin-bottom:15px; padding:0px;">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-5 col-md-5 col-lg-5">
                ...
                <h4>Date: March 17, 2016</h4> 
                <p><p>Headline: This is a post for testing and all that jazz.</p></p>
                <h4>Categories: Melee, Announcements, Blog, Events</h4>
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <h3>March 18, 2016</h3>
                <h4>Test Number Two!</h4>
                <p><p>This is another test to see if our blog page is working well! &nbsp;</p>
</p>
